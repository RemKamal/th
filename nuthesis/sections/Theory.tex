...
\multirow{2}{*}{Leptons} &Charged  & Electron (e)                 & Muon($\mu$)                & Tau ($\tau$)                 \\%\hline
...
\begin{figure}[!h]
  \centering
  \includegraphics[width=0.45\textwidth]{quarks_decay}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.65\textwidth]{fund_interac}
...
\begin{figure}[h!]
\centering
    \includegraphics[width=\textwidth]{fi_scatt}
